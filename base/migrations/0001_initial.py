    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='base.topic')),
            ],
            options={
                'db_table': 'Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('room', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='base.room')),
